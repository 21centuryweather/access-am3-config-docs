...
* Specific list of output variables and frequencies (3- and 6-hourly). 
...
The default configuration runs with a `n96` restart file from January 1, 2007. There may be other restart files available for different dates and resolutions, you can use the [AM3 subcategory](https://forum.access-hive.org.au/c/atmosphere/am3/243) on the Hive to get more information about this.  
...
* `ozone`: monthly mean from 1979 to 2014 based on the CMIP6 dataset: Hegglin, Michaela; Kinnison, Douglas; Lamarque, Jean-Francois; Plummer, David (2016). CCMI ozone in support of CMIP6 - version 1.0. Earth System Grid Federation. [https://doi.org/10.22033/ESGF/input4MIPs.1115](https://doi.org/10.22033/ESGF/input4MIPs.1115)
