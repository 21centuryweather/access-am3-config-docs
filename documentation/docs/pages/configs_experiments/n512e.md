...
The `n512e-aeroclim` configuration is based on the beta `n96e` configuration with a few changes to accommodate for the higher resolution requirements. The main changes in the `n512-aeroclim` configuration are:
